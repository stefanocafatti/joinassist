...
const StudentDashboard = () => {
  ...
  const handleToggleViewMode = () => {
    setViewMode(viewMode === "provider" ? "requester" : "provider");
    // Reset active tab when switching views
    setActiveTab("dashboard");
    toast.success(`Switched to ${viewMode === "provider" ? "Requester" : "Provider"} view`);
  };
      ...
      <div className="container mx-auto px-4 py-4">
            ...
            <div className="flex flex-col mt-4 md:mt-0 md:items-end">
              <div className="flex flex-col items-end gap-2">
                ...
                <div className="flex items-center gap-2 bg-white/10 p-2 rounded-lg">
                  <span className="text-white text-sm">Task Provider</span>
                  <Switch 
                    checked={viewMode === "requester"} 
                    onCheckedChange={handleToggleViewMode}
                    className="data-[state=checked]:bg-white data-[state=unchecked]:bg-white/50"
                  />
                  <span className="text-white text-sm">Task Requester</span>
                </div>
              </div>
            </div>
          </div>
        ...
        {viewMode === "provider" ? (
          <Tabs defaultValue="dashboard" onValueChange={setActiveTab} className="space-y-8">
              ...
              <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
                ...
                <div className="divide-y divide-gray-100">
                  {upcomingTasks.map((task, index) => (
                    <div key={index} className="p-5 hover:bg-blue-50/50 transition-colors">
                  ...
                  {upcomingTasks.length === 0 && (
                    <div className="p-8 text-center">
                      <p className="text-gray-500">You have no upcoming tasks. Browse available tasks to find work!</p>
                    </div>
                  )}
                </div>
              </div>
            ...
            <TabsContent value="earnings" className="space-y-8 animate-fade-in">
              <StudentBalance />
            </TabsContent>
            ...
            <TabsContent value="withdrawal" className="space-y-8 animate-fade-in">
              <StudentWithdrawal />
            </TabsContent>
          </Tabs>
        ) : (
          <Tabs defaultValue="dashboard" onValueChange={setActiveTab} className="space-y-8">
            <div className="bg-white rounded-xl p-2 shadow-md">
              <TabsList className="grid w-full grid-cols-3 md:grid-cols-4 gap-2 p-1">
                <TabsTrigger value="dashboard" className="flex items-center gap-2 py-3 data-[state=active]:bg-assist-blue data-[state=active]:text-white">
                  <UserRound className="h-4 w-4" />
                  <span className="hidden md:inline">Dashboard</span>
                </TabsTrigger>
                <TabsTrigger value="tasks" className="flex items-center gap-2 py-3 data-[state=active]:bg-assist-blue data-[state=active]:text-white">
                  <Briefcase className="h-4 w-4" />
                  <span className="hidden md:inline">Book Tasks</span>
                </TabsTrigger>
                <TabsTrigger value="requests" className="flex items-center gap-2 py-3 data-[state=active]:bg-assist-blue data-[state=active]:text-white">
                  <CheckCircle className="h-4 w-4" />
                  <span className="hidden md:inline">My Requests</span>
                </TabsTrigger>
                <TabsTrigger value="payments" className="flex items-center gap-2 py-3 data-[state=active]:bg-assist-blue data-[state=active]:text-white">
            ...
            <TabsContent value="dashboard" className="mt-6 space-y-8 animate-fade-in">
              <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                <Card className="overflow-hidden border-none shadow-md hover:shadow-lg transition-shadow duration-300 bg-gradient-to-br from-soft-blue to-white">
                  <CardHeader className="pb-2">
                    <CardTitle className="flex items-center text-lg text-gray-800">
                      <div className="bg-assist-blue/10 p-2 rounded-full mr-3">
                        <CheckCircle className="h-5 w-5 text-assist-blue" />
                      </div>
                      My Requests
                    </CardTitle>
                    <CardDescription>Tasks you've requested</CardDescription>
                  </CardHeader>
                  <CardContent className="pt-4">
                ...
                <Card className="overflow-hidden border-none shadow-md hover:shadow-lg transition-shadow duration-300 bg-gradient-to-br from-soft-yellow to-white">
                  <CardHeader className="pb-2">
                    ...
                    <CardDescription>Your university</CardDescription>
                  </CardHeader>
                  <CardContent className="pt-4">
                    <div className="text-lg font-medium text-gray-900">{campus}</div>
              ...
              <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
                <div className="border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white px-6 py-5">
                  <div className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-assist-blue mr-2" />
                    <h2 className="text-xl font-semibold text-gray-900">Recent Requests</h2>
                  </div>
                  <p className="mt-1 text-sm text-gray-500 ml-7">Tasks you've requested recently</p>
                </div>
                
                <div className="divide-y divide-gray-100">
                  {requests.map((request) => (
                    <div key={request.id} className="p-5 hover:bg-blue-50/50 transition-colors">
                      <div className="flex justify-between items-center">
                        <div>
                        ...
                        <div className="flex flex-col items-end space-y-1">
                          ...
                          <span className="font-bold text-assist-blue">{request.price}</span>
                        </div>
                      </div>
                    </div>
                  ))}
                ...
                <div className="border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white px-6 py-5">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <h2 className="text-xl font-semibold text-gray-900">Book a Task</h2>
                    </div>
                    <p className="text-sm text-gray-500">Find help from other students</p>
                  </div>
                  ...
                  <div className="mt-5 flex items-center gap-4">
                    ...
                    <Popover>
                      ...
                      <PopoverContent className="w-64 p-0 border-none rounded-xl shadow-xl">
                        <div className="p-4 bg-gradient-to-r from-assist-blue to-indigo-600 rounded-t-xl">
                          <h3 className="text-lg font-semibold text-white">Task Categories</h3>
                        </div>
                        
                        <div className="p-3 space-y-1">
                          <Button 
                            variant={filterCategory === "all" ? "dashboard" : "ghost"}
                          ...
                          <Button 
                            variant={filterCategory === "Academic Help" ? "dashboard" : "ghost"}
                            className="w-full justify-start"
                            onClick={() => setFilterCategory("Academic Help")}
                          >
                            Academic Help
                          </Button>
                          <Button 
                            variant={filterCategory === "Digital Services" ? "dashboard" : "ghost"}
                            className="w-full justify-start"
                            onClick={() => setFilterCategory("Digital Services")}
                          >
                            Digital Services
                          </Button>
                          <Button 
                            variant={filterCategory === "Fitness & Wellness" ? "dashboard" : "ghost"}
                            className="w-full justify-start"
                            onClick={() => setFilterCategory("Fitness & Wellness")}
                          >
                            Fitness & Wellness
                          </Button>
                          <Button 
                            variant={filterCategory === "Campus Services" ? "dashboard" : "ghost"}
                            className="w-full justify-start"
                            onClick={() => setFilterCategory("Campus Services")}
                          >
                            Campus Services
                          </Button>
                        </div>
            ...
            <TabsContent value="payments" className="space-y-8 animate-fade-in">
              <div className="bg-white rounded-xl shadow-md p-6">
                ...
                <p className="text-gray-500">View your past payments and manage payment methods.</p>
                ...
                <div className="mt-4 space-y-4">
                  ...
                  <div className="p-4 border border-gray-200 rounded-lg flex justify-between items-center">
                    <div>
                      <h3 className="font-medium">Room Cleaning</h3>
                      <p className="text-sm text-gray-500">May 7, 2023</p>
                    </div>
                  ...
                  <div className="p-4 border border-gray-200 rounded-lg flex justify-between items-center">
                    <div>
                      <h3 className="font-medium">Grocery Delivery</h3>
